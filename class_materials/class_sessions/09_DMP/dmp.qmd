...
1. The [DMP Tool (https://dmptool.org/)](https://dmptool.org/) is a free, open-source, application that helps researchers create data management plans (DMPs). It provides an easy-to-use platform for creating a DMP that complies with the requirements of different private and public funding agencies (e.g., foundations, NSF, NIH). It also has direct links to funder websites, help text for answering questions, and data management best practices resources.

<!-- Another tools for creating DMPs is the [DMP Online](dmponline.dcc.ac.uk) -->

## What should go in my DMP? 
...
1. NSF General: [Mauna Loa example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/instructor-materials/class-sessions/09-DMP/example_dmps/DMP_MaunaLoa_Formatted.pdf)
1. NSF General: [Rio Grande example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/instructor-materials/class-sessions/09-DMP/example_dmps/Repository%20selection%20exercise%20Data%20One%20Geosciences%20DMP.pdf)
1. NSF DEB: [Emilio Bruna Heliconia example](https://github.com/BrunaLab/LAS6292_DataManagement/blob/master/instructor-materials/class-sessions/09-DMP/example_dmps/DataManagementPlan.pdf)

### Sample DMPs on the 'DMP Tool' website  {.unnumbered}

1. [Public DMPs](https://dmptool.org/public_plans) **(_note: "Public DMPs are plans created using the dmptool service and shared publicly by their owners. They are not vetted for quality, completeness, or adherence to funder guidelines."_)**

### Humanities DMPs {.unnumbered}
 
1. National Endowment for the Humanities: Data Management Plans From Successful Grant Applications (2015-2018) and (2011 - 2014) can be found as downloadable zip files [on this page](https://www.neh.gov/about/foia/library)

1. A *really* nice [DMP for a Digital Humanities Project](https://guides.library.ucla.edu/c.php?g=180580&p=1189056) by researchers at the University of Maryland, College Park.
