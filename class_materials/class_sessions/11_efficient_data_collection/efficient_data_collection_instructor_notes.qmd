...
3. **Most people, whether they know it or not, collect data on some kind of form**. Sometimes these forms are paper, sometimes electronic. Notes scribbled on a piece of paper or MS Word document? Both simple forms. To design better forms - forms that reduce the number of errors at both the colleciton and entry phases - we will use some ideas from manufacturing, shipping, and design industries, along with loads of research on forms themselves.
...
1. **Breakout: ** Process Audit of Data Forms
<!-- (`r breakout1` min) -->
...
### **Topic 2 Overview:  Lessons from UI/UX**  
<!-- (`r t2_overview` min): -->
...
### Breakout 2: In-class Assignment 
<!-- (`r breakout2` min) -->
