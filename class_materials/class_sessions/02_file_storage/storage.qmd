...
# Data Storage & Backup {#sec-data-storage}
...
### The Back-up Rule: 3-2-1 {.unnumbered}
...
### File formats for storage  {.unnumbered}
...
### Overview of 'Checksums' and Checksum Calculators {.unnumbered}

* [Fisher, Tim. What Is a Checksum?](https://www.lifewire.com/what-does-checksum-mean-2625825)  (updated 15 April 2020).

### File Formats and Extensions {.unnumbered} 

* UF library [recommended Data Formats for Preservation Purposes in the Florida Digital Archive](https://ufdc.ufl.edu/AA00017119/00011/pdf)
...
### UF-based Storage Options {.unnumbered}
...
### Storage and backup for very large volumes of data (multiple TB) {.unnumbered}
...
### Tools for File Syncing  {.unnumbered}
...
### Portable HDs and Backup Services {.unnumbered} 
...
### Tools for Automating Data Uploading During Data Collection  {.unnumbered}
* [IFTTT and others](http://tinyurl.com/y9bz8suj)
  
### Online multimedia repositories and tools {.unnumbered}
...
### A step back: what needs to be preserved? {.unnumbered}
