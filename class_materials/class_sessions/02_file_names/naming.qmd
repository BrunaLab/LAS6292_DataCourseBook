...
### Best Practices & Conventions for Naming Files {.unnumbered}

* [Smithsonian Library](https://library.si.edu/sites/default/files/tutorial/pdf/filenamingorganizing20180227.pdf)
* [UF Library](https://guides.uflib.ufl.edu/datamanagement/datacollection) _(bottom of the page)_
* [Stanford Library](https://guides.library.stanford.edu/data-best-practices)

### Tutorials and Tools for Bulk Renaming of Files {.unnumbered}

* Batch Renaming of Files in Windows: [Post](https://www.pcmag.com/how-to/rename-multiple-files-at-once-in-windows?test_uuid=04IpBmWGZleS0I0J3epvMrC&test_variant=A)
...
* [Adobe Bridge](https://www.adobe.com/products/bridge.html) _(a powerful "asset manager" used to organize collections and edit metadata)_
* [Renamer (macOS)](https://renamer.com/)
