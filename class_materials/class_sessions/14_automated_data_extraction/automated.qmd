...
1. Isabella Velásquez: Creating APIs for Data Science With `plumber`: [[link](https://posit.co/blog/creating-apis-for-data-science-with-plumber)] (and the link to the [`plumbr`](https://www.rplumber.io/index.html) package)
...
1. Other Written Tutorials: [tutorial 1](http://theautomatic.net/2018/08/24/getting-data-from-pdfs-the-easy-way-with-r/), [tutorial 2](https://www.charlesbordet.com/en/extract-pdf/#), [tutorial 3](https://datascienceplus.com/extracting-tables-from-pdfs-in-r-using-the-tabulizer-package/)
1. Video Tutorials: [Video Tutorial 1](https://www.youtube.com/watch?v=DhY3V4LCdps), [Video Tutorial 2](https://www.youtube.com/watch?v=6ItyOgS2noc)
