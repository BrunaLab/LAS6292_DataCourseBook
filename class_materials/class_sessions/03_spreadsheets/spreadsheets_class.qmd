...
### **Online Lectures:**  None  {.unnumbered}
...
<!-- ### **Types of Data** (`r t1_overview` min)  {.unnumbered} -->
...
7. Export the `SAFI_messy.xlsx` as a .csv file with the name `SAFI_messy.csv`; you'll have to click the "OK" when warning box pops up.  Now reopen it. What happened? You can find a guide to saving your file in .csv format and why that is a good idea [on this website](https://datacarpentry.github.io/spreadsheet-ecology-lesson/05-exporting-data.html).
