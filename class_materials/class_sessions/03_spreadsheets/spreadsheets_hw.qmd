...
![Download Files by following the link and clicking this button.](download_button.png){width=50%}
  ...
  * `SAFI_messy.xlsx`: [download link](https://github.com/BrunaLab/LAS6292_DataCourseBook/blob/4aebeb7b92f15b59655cb47e7104c1c83df11887/class_materials/class_sessions/03_spreadsheets/examples/SAFI_messy.xlsx).
  * `untidy-portal-data.xlsx`: [download link](https://github.com/BrunaLab/LAS6292_DataCourseBook/blob/4aebeb7b92f15b59655cb47e7104c1c83df11887/class_materials/class_sessions/03_spreadsheets/examples/untidy-portal-data.xlsx).
  * `dates.xlsx`: {download link](https://github.com/BrunaLab/LAS6292_DataCourseBook/blob/4aebeb7b92f15b59655cb47e7104c1c83df11887/class_materials/class_sessions/03_spreadsheets/examples/dates.xlsx)
...
Most data validation properly programmed; some require instructor follow-up: 30
Many of the validation parameters need corrections, error messages not useful: 25
